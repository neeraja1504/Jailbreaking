...
To generate paper summaries of malicious papers/existing papers, run the following:
```
python stereotype_jailbreak-main/KB/query_research.py
```

Using the paper summary generated above, to jailbreak a model run the following by plugging in appropriate API keys for the models:
```
python stereotype_jailbreak-main/multi_turn/multi_turn_chat.py
```
